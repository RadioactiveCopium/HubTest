local function ForcePart(v)
	if v:IsA("BasePart") and v.Parent ~= game.Players.LocalPlayer.Character and not v.Anchored and not v.Parent:FindFirstChildOfClass("Humanoid") and not v.Parent:FindFirstChild("Head") and v.Name ~= "Handle" then
